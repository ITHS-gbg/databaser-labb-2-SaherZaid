...
namespace Database.Migrations
{
    ...
    [Migration("20231223211824_first")]
    partial class first
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entities.AuthorBook", b =>
                {
                    b.Property<int?>("AuthorId")
                        .HasColumnType("int")
                        .HasColumnName("author_id");
            ...
            modelBuilder.Entity("Database.Entities.BooksInventory", b =>
                {
            ...
            modelBuilder.Entity("Database.Entities.BookstoreInfo", b =>
                {
            ...
            modelBuilder.Entity("Database.Entities.InventoryBalance", b =>
                {
                    b.Property<int>("StoreId")
                        .HasColumnType("int")
                        .HasColumnName("Store_id");
            ...
            modelBuilder.Entity("Database.Entities.Shift", b =>
                {
            ...
            modelBuilder.Entity("Database.Entities.Store", b =>
                {
                    b.Property<int>("StoreID")
                        .HasColumnType("int")
                        .HasColumnName("Store_iD");
            ...
            modelBuilder.Entity("Database.Entities.TitlesPerAuthor", b =>
                {
                    b.Property<int?>("Age")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore", b =>
                {
                    b.HasOne("Database.Entities.Book", null)
                        .WithMany()
                        .HasForeignKey("BooksIsbn13")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Database.Entities.Store", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Database.Entities.Book", b =>
                {
                    b.HasOne("Database.Entities.Author", "AuthorNoNavigation")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Database.Entities.Employee", b =>
                {
                    b.HasOne("Database.Entities.Store", "Store")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Database.Entities.InventoryBalance", b =>
                {
                    b.HasOne("Database.Entities.Book", "Isbn13Navigation")
            ...
            modelBuilder.Entity("Database.Entities.Order", b =>
                {
                    b.HasOne("Database.Entities.Customer", "CustomerNoNavigation")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerNo")
                        .HasConstraintName("Orders_Customers_FK");

                    b.HasOne("Database.Entities.Book", "ReferenceNumberNavigation")
                        .WithMany("Orders")
                        .HasForeignKey("ReferenceNumber")
                        .HasConstraintName("Orders_Books_FK");

                    b.HasOne("Database.Entities.Store", "StoreNoNavigation")
                        .WithMany("Orders")
